...
namespace BearsShiftyEarth
{
    public class ShiftySettings
    {
        ...
        public string BlockTraitModifiersComment { get => "What bonuses or penalties a block should have based on its composition. By default, clay is more solid than normal soil (unless wet), while peat is amorphous and prone to 'peat slides' and 'bog bursts.'"; }
        ...
        public int MaxmimumClayStormPenalty { get; set; } = -20;
